...
class PropertyPartner(models.Model):
    _name = 'estate.property.partner'
    _description = 'Property Partner'
    name = fields.Char(string="Nama Partner", required=True)
    partner_id = fields.Char(string="Partner ID",required=True)
    agent_id = fields.Char(string="Agent ID",required=True)
    id_type = fields.Many2one('estate.property.type', string="Property Type")